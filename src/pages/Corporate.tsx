    ...
    <div className="flex flex-col w-full bg-white">
      ...
      <section className="py-16 sm:py-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Call To Action — Prose dışında, bağımsız bölüm */}
          <div className="mt-16 relative rounded-2xl overflow-hidden bg-gray-900 shadow-2xl shadow-gray-900/30">
            {/* Top accent bar */}
            ...
            <div className="relative z-10 px-6 sm:px-10 py-8 sm:py-10">
              ...
              <p className="text-gray-400 leading-relaxed text-base mb-6 max-w-lg">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <a
                  ...
                  className="inline-flex items-center justify-center gap-2.5 px-7 py-4 bg-brand-600 hover:bg-brand-500 text-white font-semibold rounded-xl transition-all shadow-lg shadow-brand-900/40 text-sm"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex items-center justify-center gap-2.5 px-7 py-4 bg-white/10 hover:bg-white/20 border border-white/15 text-white font-semibold rounded-xl transition-all text-sm"
                >
