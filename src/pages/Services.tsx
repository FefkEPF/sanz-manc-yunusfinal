...
export default function Services() {
  // Extending the existing 4 services to cover the 11 explicitly requested for the catalog view natively:
  const allServices = [
    ...servicesData,
    {
      id: "ikinci-el",
      title: "İkinci El Şanzıman",
  ...
  return (
    <div className="flex flex-col w-full bg-gray-50 min-h-screen">
      <SEO 
        ...
        description="Manuel ve otomatik şanzıman tamiri, DSG/EDC kavrama ve mekatronik revizyonları, sıfır ve çıkma şanzıman satışı, makineyle yağ değişimi hizmetlerimiz."
      ...
      <section className="bg-gray-900 py-24 relative overflow-hidden">
        <div className="absolute inset-0 opacity-20 bg-[url('https://images.unsplash.com/photo-1503328427499-d92d1fa3ce45?q=80&w=2000&auto=format&fit=crop')] bg-cover bg-center" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {allServices.map((service, index) => (
              ...
              >
                ...
                <span className="inline-flex items-center gap-2 text-brand-600 font-semibold group-hover:gap-3 transition-all text-sm cursor-pointer justify-center w-full bg-gray-50 border border-gray-100 py-3 rounded-lg group-hover:bg-brand-50 group-hover:border-brand-100 group-hover:text-brand-700">
